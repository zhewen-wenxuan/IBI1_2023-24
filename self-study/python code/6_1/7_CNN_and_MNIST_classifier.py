...
class SimpleCNN(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1, 32, 3, 1)  # 输入通道为1，输出通道为32，卷积核大小为3x3，步幅为1
        self.conv2 = nn.Conv2d(32, 64, 3, 1) # 输入通道为32，输出通道为64，卷积核大小为3x3，步幅为1
        self.fc1 = nn.Linear(12*12*64, 128) # 输入特征维度为12*12*64，输出特征维度为128
...
def visualize_predictions():
    ...
    plt.savefig('/mnt/python_learn/6_1/7_CNN_predictions.png')  # 保存图像
